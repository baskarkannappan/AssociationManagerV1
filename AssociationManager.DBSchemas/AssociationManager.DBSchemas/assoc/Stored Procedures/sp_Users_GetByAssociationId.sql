...
BEGIN 
    ...
    SELECT u.UserId, u.TenantId, u.GoogleId, u.Email, u.Name, u.PictureUrl, u.CreatedDate, u.LastLoginDate, u.IsActive, 
           ua.Role 
    FROM assoc.Users u 
    ...
    SELECT DISTINCT u.UserId, u.TenantId, u.GoogleId, u.Email, u.Name, u.PictureUrl, u.CreatedDate, u.LastLoginDate, u.IsActive, 
           'Resident' as Role
    FROM assoc.Users u
