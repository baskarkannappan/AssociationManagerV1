-- Script0080: Association Bulk Delete Procedure
-- This script provides a single-transaction procedure to remove an association and all its child records.
...
CREATE OR ALTER PROCEDURE corp.sp_Association_BulkDelete
    @AssociationId INT
AS
BEGIN
    SET NOCOUNT ON;
