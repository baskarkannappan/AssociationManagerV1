-- Script0099_AssetInvoiceTreeReport.sql
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[assoc].[sp_Analyze_AssetInvoiceTree]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [assoc].[sp_Analyze_AssetInvoiceTree]
GO
