-- Script0075_SupportMultiAssetPaging.sql
-- Update Invoices Paging procedure to support multiple asset IDs simultaneously.

PRINT 'Updating assoc.sp_Invoices_GetPaged to support multi-asset filtering...'
GO
