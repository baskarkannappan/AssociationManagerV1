-- Script0074_FixedDashboardMetrics.sql
-- Fixes for dashboard metrics to ensure they reflect ledger balances and all revenue.

PRINT 'Updating assoc.sp_Finance_GetAssociationSummary for accurate metrics...'
GO
