-- Script0078_DeduplicateUserPaging.sql
-- Optimised and Deduplicated Association Member Paging with Balance Tracking.

PRINT 'Updating assoc.sp_Users_GetPaged to deduplicate members and add balance tracking...'
GO
