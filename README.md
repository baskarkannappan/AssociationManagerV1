# Association Manager V1 - Database Seeding

This document contains the seed data scripts for initializing the `AssociationManageruat` database.

## How to use
1. Connect to your SQL Server instance.
2. Ensure the database `AssociationManageruat` exists and the schema has been deployed.
3. Run the following script to populate lookup tables and sample data.
...
- **Tenant**: Default Platform Tenant (ID: 1)
- **Association**: Springfield Gardens HOA (ID: 1)
- **Users**: 
  - Admin (admin@springfield.com)
  - Resident (resident@springfield.com)
- **Assets**: Building A with Units 101 and 102.
- **Roles**: President, Secretary, Treasurer, Member.
- **Billing**: Monthly maintenance flat charge (1500.00) assigned to units.
- **Bank**: Sample Axis Bank primary account details for the HOA.
